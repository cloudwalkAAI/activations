...
<h1 class="text-center">Post Evaluation (Intial)</h1>
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 column">
        <table>
          ...
          <tbody>
            <?php
                  $iped_data = $this->db->get_where( 'project_attachments', array( 'reference_for' => 'initial' ) );
                  if ($iped_data->num_rows() > 0)
                  {
                      foreach ( $iped_data->result() as $row )
                      {
