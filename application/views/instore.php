...
<h1 class="text-center">In-Store</h1>
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 column">
        <table>
          ...
          <tbody>
            <?php
                  $instore_data = $this->db->get_where( 'project_attachments', array( 'reference_for' => 'in-store' ) );
                  if ($instore_data->num_rows() > 0)
                  {
                      foreach ( $instore_data->result() as $row )
                      {
