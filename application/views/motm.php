...
<h1 class="text-center">Minutes of the Meeting</h1>
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 column">
        <table>
          ...
          <tbody>
            <?php
                  $motm_data = $this->db->get_where( 'project_attachments', array( 'reference_for' => 'mom' ) );
                  if ($motm_data->num_rows() > 0)
                  {
                      foreach ( $motm_data->result() as $row )
                      {
