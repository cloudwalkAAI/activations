...
<h1 class="text-center">Bid Deck</h1>
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 column">
        <table>
          ...
          <tbody>
            <?php
                  $biddeck_data = $this->db->get_where( 'project_attachments', array( 'reference_for' => 'bid_deck' ) );
                  if ($biddeck_data->num_rows() > 0)
                  {
                      foreach ( $biddeck_data->result() as $row )
                      {
