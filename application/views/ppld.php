...
<h1 class="text-center">Pre - Prod and Logistics</h1>
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 column">
        <table>
          ...
          <tbody>
            <?php
                  $ppld_data = $this->db->get_where( 'project_attachments', array( 'reference_for' => 'logistics' ) );
                  if ($ppld_data->num_rows() > 0)
                  {
                      foreach ( $ppld_data->result() as $row )
                      {
