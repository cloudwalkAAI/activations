...
<h1 class="text-center">Post Evaluation (Final)</h1>
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 column">
        <table>
          ...
          <tbody>
            <?php
                  $fped_data = $this->db->get_where( 'project_attachments', array( 'reference_for' => 'final' ) );
                  if ($fped_data->num_rows() > 0)
                  {
                      foreach ( $fped_data->result() as $row )
                      {
