    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 column">
        <table>
          ...
          <tbody>
            <?php
                  $activations_data = $this->db->get_where( 'project_attachments', array( 'reference_for' => 'activations' ) );
                  if ($activations_data->num_rows() > 0)
                  {
                      foreach ( $activations_data->result() as $row )
                      {
