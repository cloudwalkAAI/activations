<li class="jolist cl-item-<?php echo $row['client_id']; ?>" alt="<?php echo $row['client_id']; ?>">
	<div class="small-7 medium-8 large-8 columns" style="padding: 50px;">
		<h3><?php echo $row['company_name']; ?></h3>
		<h5><?php echo '<a class="load_client" href="#" alt="'.$row['client_id'].'">Client NO.'.str_pad( $row['client_id'], 6, "0", STR_PAD_LEFT ).'</a>'; ?></h5>
	...
	<div class="small-5 medium-4 large-4 columns text-right" style="padding: 12px;">
		...
		<div class="large-12 columns text-right" style="padding-right: 30px;">
			<p style="margin-top: 41px;"><?php echo $row['contact_person']; ?></p>
