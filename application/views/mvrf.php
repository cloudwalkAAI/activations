...
<h1 class="text-center">Manpower and Vehicle Request Form</h1>
    ...
    <div class="row">
      <div class="small-12 medium-12 large-12 column">
        <table>
          ...
          <tbody>
            <?php
                  $mvrf_data = $this->db->get_where( 'project_attachments', array( 'reference_for' => 'mvrf' ) );
                  if ($mvrf_data->num_rows() > 0)
                  {
                      foreach ( $mvrf_data->result() as $row )
                      {
